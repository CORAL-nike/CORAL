...
from .utilities.supersingular import fix_torsion_basis_renes, torsion_basis
...
if __name__ == "__main__":
    ...
    def test_generate_splitting_kernel(param_index=1):
        ...
        # Compute torsion basis
        P2, Q2 = torsion_basis(E0, 4 * A)
        P2, Q2 = fix_torsion_basis_renes(P2, Q2, ea + 2)  # Ensure (0,0) will not be in the kernel
        P3, Q3 = torsion_basis(E0, B)
        ...
        phiA, EA = isogeny_from_scalar_x_only(E0, A, alice_secret, basis=(4 * P2, 4 * Q2))
