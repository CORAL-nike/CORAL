...
class ThetaStructureDim2:
    ...
    def _arithmetic_precomputation(self):
        ...
        if self._precomputation is None:
            ...
            b_inv, c_inv, d_inv, BB_inv, CC_inv, DD_inv = batch_inversion([b, c, d, BB, CC, DD])
...
class ProductThetaStructureDim2(ThetaStructureDim2):
    def __init__(self, *args):
        ...
        if len(args) == 2:
            ...
            raise ValueError(
                f"2 or 4 arguments expected but {len(args)} were given.\nYou should enter a list of 2 elliptic curves or ThetaStructureDim1\nor a list of 2 elliptic curves with a 4-torsion basis for each of them."
            )
