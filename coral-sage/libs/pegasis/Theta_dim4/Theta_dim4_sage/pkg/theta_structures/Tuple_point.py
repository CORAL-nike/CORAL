...
class TuplePoint:
    ...
    def __add__(self, other):
        ...
        if n_self != n_other:
            raise ValueError(f"Cannot add TuplePoint of distinct lengths {n_self} and {n_other}.")
    ...
    def __sub__(self, other):
        ...
        if n_self != n_other:
            raise ValueError(f"Cannot substract TuplePoint of distinct lengths {n_self} and {n_other}.")
    ...
    def weil_pairing(self, other, n):
        ...
        if n_self != n_other:
            raise ValueError(
                f"Cannot compute the Weil pairing of TuplePoint of distinct lengths {n_self} and {n_other}."
            )
