...
from ..basis_change.kani_base_change import (
    ...
    kernel_basis,
    splitting_base_change_matrix_dim4,
    starting_two_symplectic_matrices,
)
from ..isogenies.isogeny_chain_dim4 import IsogenyChainDim4
from ..isogenies.Kani_gluing_isogeny_chain_dim4 import (
    KaniGluingIsogenyChainDim4,
    KaniGluingIsogenyChainDim4Half,
)
...
from ..theta_structures.Theta_dim4 import ProductThetaStructureDim1To4
...
def form_kernel(x, y, P1, Q1, R2, S2, T1, U1):
    ...
    if x % 2 == 1:
        a = -inverse_mod(x, 4)
        B_Kpp = [
            TuplePoint(xP1 + a * T1, yP1, R2, OE2),
            TuplePoint(xQ1, yQ1, S2, OE2),
            TuplePoint(-yP1, xP1, OE2, R2),
            TuplePoint(-yQ1, xQ1 + a * U1, OE2, S2),
        ]
    else:
        b = -inverse_mod(y, 4)
        B_Kpp = [
            TuplePoint(xP1, yP1 + b * T1, R2, OE2),
            TuplePoint(xQ1, yQ1, S2, OE2),
            TuplePoint(-yP1, xP1, OE2, R2),
            TuplePoint(-yQ1 - b * U1, xQ1, OE2, S2),
        ]
...
class KaniEndo(IsogenyChainDim4):
    ...
    def __init__(self, P1, Q1, R2, S2, q, a1, a2, e, f=None, strategy=None):
        ...
        B_Kpp = form_kernel(
            a1, a2, P1_doubles[0], Q1_doubles[0], R2_doubles[0], S2_doubles[0], P1_doubles[-1], Q1_doubles[-1]
        )
        ...
        M_split = splitting_base_change_matrix_dim4(
            a1,
            a2,
            q,
            m,
            self.gluing_isogeny_chain.M_product_dim2,
            self.gluing_isogeny_chain.M_gluing_dim4[range(8), range(4)],
            mu,
        )
...
class KaniEndoHalf:
    ...
    def __init__(self, P1, Q1, R2, S2, q, a1, a2, e, f, strategy1=None, strategy2=None):
        ...
        points_m = [
            ...
            R2_doubles[-m - 2],
            S2_doubles[-m - 2],
        ]  # Points of order 2**(m+3)

        self.gluing_isogeny_chain1 = KaniGluingIsogenyChainDim4Half(
            points_m, a1, a2, q, m, Theta12, M0, M1, M_gluing_1, e4, False
        )
        self.gluing_isogeny_chain2 = KaniGluingIsogenyChainDim4Half(
            points_m, a1, a2, q, m, Theta12, M0, M2, M_gluing_2, e4, True
        )
