...
# Sage Imports
from sage.all import GF, ZZ, Integers

from ..utilities.discrete_log import discrete_log_pari, ell_discrete_log_pari, weil_pairing_pari
from ..utilities.fast_sqrt import sqrt_Fp, sqrt_Fp2
...
def generate_point_order_D(E, D, x_start=0):
    ...
    raise ValueError("Never found a point P of order D.")
...
def torsion_basis_with_pairing(E, D):
    ...
    if (p + 1) % D != 0:
        ...
        raise ValueError("D must divide the point's order")
